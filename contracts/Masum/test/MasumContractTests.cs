...
namespace MasumTests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class MasumContractTests : IClassFixture<CheckpointFixture<MasumContractTests>>
    {
        ...
        public MasumContractTests(CheckpointFixture<MasumContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<MasumContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<MasumContract>(c => c.changeNumber(42));
