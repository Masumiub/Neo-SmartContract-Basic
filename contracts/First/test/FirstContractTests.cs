...
namespace FirstTests
{
    ...
    public class FirstContractTests : IClassFixture<CheckpointFixture<FirstContractTests>>
    {
        ...
        public FirstContractTests(CheckpointFixture<FirstContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<FirstContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<FirstContract>(c => c.changeNumber(42));
